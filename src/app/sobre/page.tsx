...
export default function Sobre() {
  return (
    <main className="min-h-screen bg-white pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative h-[500px] rounded-[40px] overflow-hidden shadow-2xl">
              <img src="https://i.imgur.com/DT0pAf7.png" className="w-full h-full object-cover" alt="Alcides Viegas" />
            </div>
          </div>
        </div>
      </section>

      {/* NOVA SECÇÃO: MISSÃO, VISÃO E VALORES */}
      ...
      {/* NOVA SECÇÃO: CONSELHO DE ADMINISTRAÇÃO */}
